...
//     * 定义切点Pointcut
//     */
//    @Pointcut("@annotation(com.kaltsit.ascept.annotation.Dict)")
...
//            if (((JsonResult) result).getData() instanceof IPage) {
...
//                //取出结果集
//                List<Object> records=((IPage) ((JsonResult) result).getData()).getRecords();
...
//                    JSONObject item = JSONObject.parseObject(json, JSONWriter.Feature.OrderedField);
...
//                }
//
//                ((IPage) ((JsonResult) result).getData()).setRecords(items);
//            }
//
//        }
//        return result;
